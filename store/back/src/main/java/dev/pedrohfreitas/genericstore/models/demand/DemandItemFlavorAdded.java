...
@AllArgsConstructor
@Entity
@Table(name = "d_item_added")
public class DemandItemFlavorAdded {
	
	public DemandItemFlavorAdded() {
	...
	@Column(name = "id_added", nullable = false, updatable = false)
	private Long added;
	
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "id_demand_item_flavor")
